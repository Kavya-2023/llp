...
const SubCourse = () => {
  ...
  return (
    <>
      <NavBar />
      <div className="subcourses-container bg-amber-100 h-[100vh] relative" style={{ backgroundImage: `url(${category.imgUrl})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
